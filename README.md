# BugBlow Public Security Audit Reports
Public security audit reports performed by the BugBlow team.

| Client | Project | Category | Report | Date |
|---|---|---|---|---|
| Flipper | Flipper | Perps Aggregator | [📋](https://github.com/BugBlow/audits/blob/main/Flipper_Perps_Aggregator_Security_Audit_By_BugBlow.pdf) | March 17, 2026 |
| Flake Exchange | Flake Router | Router | [📋](https://github.com/BugBlow/audits/blob/main/Flake_Exchange_Security_Audit_Report_By_BugBlow.pdf) | March 17, 2026 |
| ODDS8 | ODDS8 Prediction (Sol) | Prediction Market | [📋](https://github.com/BugBlow/audits/blob/main/ODDS8/ODDS8_Sol_Security_Audit_Report_By_BugBlow.pdf) | March 4, 2026 |
| Preduck Games | Preduck Games (Sol) | Prediction Market | [📋](https://github.com/BugBlow/audits/blob/main/PreduckGames/PreduckGames_Sol_Security_Audit_Report_By_BugBlow.pdf) | Dec 8, 2025 |
| ODDS8 | Preduck Games (EVM) | Prediction Market | [📋](https://github.com/BugBlow/audits/blob/main/ODDS8/ODDS8_EVM_Security_Audit_Report_By_BugBlow.pdf) | Dec 8, 2025 |
| J Bot | Swap and Referral Program | Swap | [📋](https://github.com/BugBlow/audits/blob/main/JBot/JBot_Referral_Program_SC_EVM_By_BugBlow.pdf) | Dec 5, 2025 |
...
| Lumia | Morphex | DEX | [📋](https://github.com/BugBlow/audits/blob/main/Lumia_Morphex_Security_Audit_Report_By_BugBlow.pdf) | Jul 1, 2025 |
| OdinX | OdinTrade | Algorithmic Trading / Yield | [📋](https://github.com/BugBlow/audits/blob/main/OdinTrade_Security_Audit_Report_By_BugBlow.pdf) | May 24, 2025 |
